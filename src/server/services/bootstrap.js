...
export async function ensureBootstrap(env, user, accountId = ACCOUNT_ID) {
  ...
  await db.insert(inquiries).values({ id: seed.inquiry, accountId, companyId: seed.company, contactId: seed.contact, siteId: seed.site, ownerUserId: user.id, title: "NTT Data", serviceType: "data_center_decommissioning", sourceChannel: "phone", priority: "high", workload: "medium", status: "needs_info", estimatedLowCents: 2_850_000, estimatedHighCents: 4_500_000, confidenceScore: 78, leaseEndDate: "2025-07-31", lastCustomerActivityAt: new Date().toISOString() });
