...
export async function createLocalEnv(options = {}) {
  ...
  return {
    ...
    CRM_PROVIDER_WEBHOOK: process.env.CRM_PROVIDER_WEBHOOK || localEnv.CRM_PROVIDER_WEBHOOK || "",
    STORAGE_PROVIDER_WEBHOOK: process.env.STORAGE_PROVIDER_WEBHOOK || localEnv.STORAGE_PROVIDER_WEBHOOK || "",
    INTEGRATION_PROVIDER_WEBHOOK: process.env.INTEGRATION_PROVIDER_WEBHOOK || localEnv.INTEGRATION_PROVIDER_WEBHOOK || "",
    GOOGLE_CLIENT_ID: process.env.GOOGLE_CLIENT_ID || localEnv.GOOGLE_CLIENT_ID || "",
    GOOGLE_CLIENT_SECRET: process.env.GOOGLE_CLIENT_SECRET || localEnv.GOOGLE_CLIENT_SECRET || "",
    GOOGLE_REDIRECT_URI: process.env.GOOGLE_REDIRECT_URI || localEnv.GOOGLE_REDIRECT_URI || "",
    GOOGLE_LOGIN_CLIENT_ID: process.env.GOOGLE_LOGIN_CLIENT_ID || localEnv.GOOGLE_LOGIN_CLIENT_ID || "",
    GOOGLE_LOGIN_CLIENT_SECRET: process.env.GOOGLE_LOGIN_CLIENT_SECRET || localEnv.GOOGLE_LOGIN_CLIENT_SECRET || "",
    GOOGLE_LOGIN_REDIRECT_URI: process.env.GOOGLE_LOGIN_REDIRECT_URI || localEnv.GOOGLE_LOGIN_REDIRECT_URI || "",
    GOOGLE_OAUTH_STATE_SECRET: process.env.GOOGLE_OAUTH_STATE_SECRET || localEnv.GOOGLE_OAUTH_STATE_SECRET || "",
    GOOGLE_TOKEN_ENCRYPTION_KEY: process.env.GOOGLE_TOKEN_ENCRYPTION_KEY || localEnv.GOOGLE_TOKEN_ENCRYPTION_KEY || "",
    AUTH_SESSION_SECRET: process.env.AUTH_SESSION_SECRET || localEnv.AUTH_SESSION_SECRET || crypto.randomUUID(),
    DEFAULT_ACCOUNT_ID: process.env.DEFAULT_ACCOUNT_ID || localEnv.DEFAULT_ACCOUNT_ID || ""
  };
}
