...
const requiredDocs = {
  "docs/operations/incident-runbook.md": ["Severity Levels", "First 15 Minutes", "Recovery"],
  "docs/operations/release-checklist.md": ["Before Staging", "Staging Verification", "Production Promotion", "Post-Launch"]
};
